(() => {
  ...
  Object.assign(dictionaries.pt, {
    ...
    partnerships_public_notice_text: 'Chamada CNPq/MCTI/FNDCT Nº 22/2024 – Programa Conhecimento Brasil – Apoio a Projetos em Rede com Pesquisadores Brasileiros no Exterior – Pesquisa com Inteligência Artificial.',
    partnerships_team_title: 'Equipe'
  });
  Object.assign(dictionaries.en, {
    nav_partnerships_new: 'Partnerships\nCollaborations',
    partnerships_collab_title: 'Other collaborations and participations',
    partnerships_collab_subtitle: 'Collaborative projects with companies and research institutes',
    partnerships_collab_intro: 'In addition to its independent projects, Databiomics® also participates in collaborative projects with companies and research institutes, and contributes to initiatives linked to funding calls and scientific networks.',
    partnerships_seascient_title: 'Sea Scient Group (Databiomics partner company)',
    partnerships_seascient_desc_1: 'Sea Scient Group offers specialized microbiome analysis tailored for aquaculture systems. Combining expertise in bioinformatics, microbiology, and aquatic animal health, the company supports businesses and researchers with data-driven insights to improve performance, disease management, and sustainability.',
    partnerships_seascient_services_title: 'Services offered by Sea Scient Group:',
    partnerships_seascient_service_1: 'Gut microbiome analysis (fish & shrimp)',
    partnerships_seascient_service_2: 'Water and system microbiome profiling',
    partnerships_seascient_service_3: 'Dysbiosis detection & health indicators',
    partnerships_seascient_service_4: 'Support for nutrition and challenge trials',
    partnerships_seascient_service_5: 'Bioinformatics & data interpretation',
    partnerships_seascient_desc_2: 'The shrimp microbiome analysis platform is being developed within a project approved under the CNPq 2024 – Conhecimento Brasil call and led by Sea Scient Group. In this initiative, Databiomics contributes to the development of the platform, especially in bioinformatics and data analysis.',
    partnerships_seascient_site: 'Visit Sea Scient Group official website',
    partnerships_terpenoscanner_desc: 'Exploring and expanding the natural chemical potential of cyanobacterial terpenes and their biotechnological potential in Portugal and Brazil through AI.',
    partnerships_public_notice_title: 'Public Notice',
    partnerships_public_notice_text: 'CNPq/MCTI/FNDCT Call No. 22/2024 – Brazil Knowledge Program – Support for Network Projects with Brazilian Researchers Abroad – Research with Artificial Intelligence.',
    partnerships_team_title: 'Team'
  });
  Object.assign(dictionaries.es, {
    nav_partnerships_new: 'Alianzas\nColaboraciones',
    partnerships_collab_title: 'Otras colaboraciones y participaciones',
    partnerships_collab_subtitle: 'Proyectos colaborativos con empresas e institutos de investigación',
    partnerships_collab_intro: 'Además de sus proyectos independientes, Databiomics® también participa en proyectos colaborativos con empresas e institutos de investigación, y contribuye a iniciativas vinculadas a convocatorias de financiamiento y redes científicas.',
    partnerships_seascient_title: 'Sea Scient Group (empresa aliada de Databiomics)',
    partnerships_seascient_desc_1: 'Sea Scient Group ofrece análisis especializados de microbioma adaptados a sistemas de acuicultura. Combinando experiencia en bioinformática, microbiología y salud de animales acuáticos, la empresa apoya a negocios e investigadores con información basada en datos para mejorar el rendimiento, la gestión de enfermedades y la sostenibilidad.',
    partnerships_seascient_services_title: 'Servicios ofrecidos por Sea Scient Group:',
    partnerships_seascient_service_1: 'Análisis de microbioma intestinal (peces y camarones)',
    partnerships_seascient_service_2: 'Perfilado del microbioma del agua y del sistema',
    partnerships_seascient_service_3: 'Detección de disbiosis e indicadores de salud',
    partnerships_seascient_service_4: 'Apoyo para ensayos de nutrición y pruebas de desafío',
    partnerships_seascient_service_5: 'Bioinformática e interpretación de datos',
    partnerships_seascient_desc_2: 'La plataforma de análisis de microbioma de camarones se está desarrollando en el marco de un proyecto aprobado en la convocatoria CNPq 2024 – Conhecimento Brasil y liderado por Sea Scient Group. En esta iniciativa, Databiomics contribuye al desarrollo de la plataforma, especialmente en bioinformática y análisis de datos.',
    partnerships_seascient_site: 'Visitar sitio oficial de Sea Scient Group',
    partnerships_terpenoscanner_desc: 'Explorando y ampliando el potencial químico natural de terpenos de cianobacterias y su potencial biotecnológico en Portugal y Brasil mediante IA.',
    partnerships_public_notice_title: 'Convocatoria pública',
    partnerships_public_notice_text: 'Convocatoria CNPq/MCTI/FNDCT Nº 22/2024 – Programa Conocimiento Brasil – Apoyo a Proyectos en Red con Investigadores Brasileños en el Exterior – Investigación con Inteligencia Artificial.',
    partnerships_team_title: 'Equipo'
  });
