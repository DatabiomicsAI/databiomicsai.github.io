(() => {
  const dictionaries = {
    pt: {
      nav_home: 'Início', nav_about: 'Sobre', nav_services: 'Serviços', nav_articles_projects: 'Artigos / Projetos', nav_training: 'Formação Complementar', nav_courses_talks: 'Cursos & Palestras', nav_videos: 'Vídeos', nav_disclosure: 'Divulgação', nav_programs: 'Programas', nav_news: 'Artigos selecionados', nav_course_plan: 'Plano de Cursos', nav_testimonials: 'Depoimentos', nav_support_projects: 'Apoie os projetos', nav_partnerships: 'Parcerias Estratégicas', nav_support_projects_cta: 'Apoie os projetos →', nav_cv_others: 'CV / Others', nav_catalog: 'Catálogo de Produtos', nav_contact: 'Contato',
