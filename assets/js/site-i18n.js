(() => {
  const dictionaries = {
    pt: {
      nav_home: 'Início', nav_about: 'Sobre', nav_services: 'Serviços e Aplicações', nav_articles_projects: 'Artigos / Projetos', nav_training: 'Formação Complementar', nav_courses_talks: 'Cursos & Palestras', nav_videos: 'Vídeos', nav_disclosure: 'Divulgação', nav_programs: 'Programas', nav_news: 'Exemplos de Aplicabilidade', nav_course_plan: 'Plano de Cursos', nav_testimonials: 'Depoimentos', nav_support_projects: 'Apoie os projetos', nav_partnerships: 'Parcerias Estratégicas', nav_support_projects_cta: 'Apoie os projetos →', nav_cv_others: 'CV / Others', nav_catalog: 'Catálogo de Produtos', nav_contact: 'Contato',
    ...
    es: {
      nav_home: 'Inicio', nav_about: 'Sobre', nav_services: 'Servicios y Aplicaciones', nav_articles_projects: 'Artículos / Proyectos', nav_training: 'Formación Complementaria', nav_courses_talks: 'Cursos y Charlas', nav_videos: 'Vídeos', nav_disclosure: 'Divulgación', nav_programs: 'Programas', nav_news: 'Ejemplos de Aplicabilidad', nav_course_plan: 'Plan de Cursos', nav_testimonials: 'Testimonios', nav_support_projects: 'Apoye los proyectos', nav_partnerships: 'Alianzas Estratégicas', nav_support_projects_cta: 'Apoye los proyectos →', nav_cv_others: 'CV / Others', nav_catalog: 'Catálogo de Productos', nav_contact: 'Contacto',
