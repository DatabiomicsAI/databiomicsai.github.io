(() => {
  const dictionaries = {
    ...
    es: {
      nav_home: 'Inicio', nav_about: 'Sobre', nav_services: 'Servicios', nav_articles_projects: 'Artículos / Proyectos', nav_training: 'Formación Complementaria', nav_courses_talks: 'Cursos y Charlas', nav_videos: 'Vídeos', nav_disclosure: 'Divulgación', nav_programs: 'Programas', nav_news: 'Selected Articles', nav_course_plan: 'Plan de Cursos', nav_testimonials: 'Testimonios', nav_support_projects: 'Apoye los proyectos', nav_support_projects_cta: 'Apoye los proyectos →', nav_cv_others: 'CV / Others', nav_catalog: 'Catálogo', nav_contact: 'Contacto',
