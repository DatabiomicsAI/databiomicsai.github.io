(() => {
  const dictionaries = {
    pt: {
      nav_home: 'Início', nav_about: 'Sobre', nav_services: 'Serviços e Aplicações', nav_articles_projects: 'Artigos / Projetos', nav_training: 'Formação Complementar', nav_courses_talks: 'Cursos & Palestras', nav_videos: 'Vídeos', nav_disclosure: 'Divulgação', nav_programs: 'Programas', nav_news: 'Exemplos de\nAplicabilidade', nav_course_plan: 'Plano de Cursos', nav_testimonials: 'Depoimentos', nav_support_projects: 'Apoie os projetos', nav_partnerships: 'Apoio empresarial', nav_partnerships_new: 'Parcerias/Colaborações', nav_support_projects_cta: 'Apoie os projetos →', nav_cv_others: 'CV / Others', nav_catalog: 'Catálogo de Produtos', nav_contact: 'Contato',
    ...
    en: {
      nav_home: 'Home', nav_about: 'About', nav_services: 'Services & Applications', nav_articles_projects: 'Articles / Projects', nav_training: 'Additional Training', nav_courses_talks: 'Courses & Talks', nav_videos: 'Videos', nav_disclosure: 'Outreach', nav_programs: 'Programs', nav_news: 'Applicability\nExamples', nav_course_plan: 'Course Plan', nav_testimonials: 'Testimonials', nav_support_projects: 'Support projects', nav_partnerships: 'Supporting Institutions', nav_partnerships_new: 'Partnerships/Collaborations', nav_support_projects_cta: 'Support projects →', nav_cv_others: 'CV / Others', nav_catalog: 'Product Catalog', nav_contact: 'Contact',
      nav_community: 'Databiomics\nCommunity',
    ...
    es: {
      nav_home: 'Inicio', nav_about: 'Sobre', nav_services: 'Servicios y Aplicaciones', nav_articles_projects: 'Artículos / Proyectos', nav_training: 'Formación Complementaria', nav_courses_talks: 'Cursos y Charlas', nav_videos: 'Vídeos', nav_disclosure: 'Divulgación', nav_programs: 'Programas', nav_news: 'Ejemplos de\nAplicabilidad', nav_course_plan: 'Plan de Cursos', nav_testimonials: 'Testimonios', nav_support_projects: 'Apoye los proyectos', nav_partnerships: 'Instituciones de apoyo', nav_partnerships_new: 'Alianzas/Colaboraciones', nav_support_projects_cta: 'Apoye los proyectos →', nav_cv_others: 'CV / Others', nav_catalog: 'Catálogo de Productos', nav_contact: 'Contacto',
      nav_community: 'Databiomics\nComunidad',
  ...
  Object.assign(dictionaries.pt, {
    nav_partnerships_new: 'Parcerias/Colaborações',
  ...
  Object.assign(dictionaries.en, {
    nav_partnerships_new: 'Partnerships/Collaborations',
  ...
  Object.assign(dictionaries.es, {
    nav_partnerships_new: 'Alianzas/Colaboraciones',
