(() => {
  ...
  loadStyle('/assets/css/ods-no-campo-profile-challenge.css?v=20260625-2', 'data-ods-profile-challenge-css');
  ...
  loadScript('/assets/js/ods-no-campo-credit-text-v2.js?v=20260721-2', 'data-ods-credit-text-v2-js');
  loadScript('/assets/js/ods-no-campo-profile-challenge.js?v=20260625-2', 'data-ods-profile-challenge-js');
})();
